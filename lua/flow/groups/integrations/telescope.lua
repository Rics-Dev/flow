...
function M.get(palette)
    return {
        TelescopeNormal = { fg = palette.bright_foreground, bg = palette.background },
        ...
        TelescopeResultsNormal = { fg = palette.bright_foreground, bg = palette.background },
        TelescopeResultsBorder = { fg = palette.border, bg = palette.background },
        ...
        TelescopePreviewNormal = { fg = palette.bright_foreground, bg = palette.background },
        TelescopePreviewBorder = { fg = palette.border, bg = palette.background },
